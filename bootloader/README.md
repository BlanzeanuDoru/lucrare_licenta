# Arduino Zero Bootloader
	The project was cloned from: https://github.com/arduino/ArduinoCore-samd/tree/master/bootloaders/zero
	The project will be adapted for SAM R21 Explained Pro Board
